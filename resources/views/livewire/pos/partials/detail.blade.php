	...
	<div class="connect-sorting-content">
		<div class="card simple-title-task ui-sortable-handle">
			<div class="card-body">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									...
									<button class="btn btn-dark mtmobile" onclick="Confirm('{{ $item->id }}', 'removeItem', '¿Confirmas Eliminar este articulo?')">
										<i class="fas fa-trash-alt"></i>
									</button>

									<button class="btn btn-dark mtmobile" wire:click="decreaseQty({{ $item->id }})">
				...
				@else
				<h5 class="text-center text-muted">Agrega productosa la ventas</h5>
				@endif
